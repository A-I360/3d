...
export default function IngredientsSection() {
  return (
    <section className="relative overflow-hidden bg-deep-brown py-28 text-ivory lg:py-40">
      {/* slow botanical drift — CSS keyframes, compositor-driven */}
      {FLOATING.map((f) => (
        <div
          key={f.src}
          className={`absolute ${f.pos} animate-floaty opacity-[0.16] grayscale-[35%]`}
          style={{
            animationDuration: `${11 + f.delay}s`,
      ...
      {/* ingredient marquee — CSS keyframes, compositor-driven */}
